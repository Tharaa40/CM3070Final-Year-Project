...
//         const {points, xp} = getPointsAndXP(task.selectedPriority);
//         await updateUserRewards(points, xp);

//         const userXP = await getUserXP();
//         const badgeUnlocked = checkForBadgeUnlock(userXP + xp);

//         if(badgeUnlocked){
//             console.log(`congratulations! you unlocked the ${badgeUnlocked} badge`);
//         }
//         onComplete();
//     }
